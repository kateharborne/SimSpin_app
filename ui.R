  ...
  tabPanel("build_datacube",
           sidebarLayout(
             sidebarPanel(
               ...
               sliderInput("pixel_sscale", label = "Spaxel scale / '' :", min = 0.1, max = 2, value = 0.5, step = 0.01),
               sliderInput("pixel_vscale", label = HTML("Voxel scale / &#8491; :"), min = 0.01, max = 2, value = 1.04, step = 0.01),
  ...
  tabPanel("find_lambda",
           sidebarLayout(
             sidebarPanel(
               ...
               sliderInput("pixel_sscale_2", label = "Spaxel scale / '' :", min = 0.1, max = 2, value = 0.5, step = 0.01),
               sliderInput("pixel_vscale_2", label = HTML("Voxel scale / &#8491; :"), min = 0.01, max = 2, value = 1.04, step = 0.01),
