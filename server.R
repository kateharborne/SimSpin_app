...
shinyServer(function(input, output, session) {
  ...
  fl <- reactive({
    ...
    } else if (input$blur_2 == "FALSE" && input$measure_type == "Specified"){
      SimSpin::find_lambda(filename = input$sim_file_3$datapath,
                           ptype = input$ptype_3,
                           r200 = input$r200_2,
                           z = input$z_2,
    ...
    } else if (input$blur_2 == "FALSE" && input$measure_type == "Fixed"){
      SimSpin::find_lambda(filename = input$sim_file_3$datapath,
                           ptype = input$ptype_3,
                           r200 = input$r200_2,
                           z = input$z_2,
    ...
    } else if (input$blur_2 == "TRUE" && input$measure_type == "Fit"){
      SimSpin::find_lambda(filename = input$sim_file_3$datapath,
                           ptype = input$ptype_3,
                           r200 = input$r200_2,
                           z = input$z_2,
    ...
    } else if (input$blur_2 == "TRUE" && input$measure_type == "Specified"){
      SimSpin::find_lambda(filename = input$sim_file_3$datapath,
                           ptype = input$ptype_3,
                           r200 = input$r200_2,
                           z = input$z_2,
    ...
    } else if (input$blur_2 == "TRUE" && input$measure_type == "Fixed"){
      SimSpin::find_lambda(filename = input$sim_file_3$datapath,
                           ptype = input$ptype_3,
                           r200 = input$r200_2,
                           z = input$z_2,
